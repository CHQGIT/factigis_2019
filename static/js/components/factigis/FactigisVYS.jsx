...
import {loadCurrentVYSData, updateAttributesPerFolio} from '../../services/factigis_services/factigis_loadVysData';
...
class FactigisVYS extends React.Component {
...
*/
    ...
    //ADD LAYER TO SHOW IN THE MAP
      ...
      layerDefs[0] = "Zona= '" + prfl.ZONA_USUARIO + "' AND Estado_tramite='EN TRAMITE' AND TIPO_MEJORA='VYS' AND EMPRESA='" + prfl.EMPRESA+ "'";
            ...
            <div className="wrapperTop">
              <div className="logo_content">
                ...
                <div className="breadcrumbs_custom">
                  ...
                  <Button className="btn_dashboard" icon='assignment_turned_in' label={'Revisión VYS:   Zona ' + this.state.zonaTitle} accent onClick={this.onClickDashboard.bind(this,"")}/>
                </div>
              </div>
